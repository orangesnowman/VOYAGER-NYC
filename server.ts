  ...
  wss.on("connection", async (clientWs, request) => {
    ...
    async function connectSession(modelName: string): Promise<any> {
      ...
      const languageInstruction = lang === "ES" 
        ? "\n\nLANGUAGE CONFIGURATION: The user's preferred language is Spanish (ES). You should default to speaking and responding in Spanish. However, if you hear people speaking English, ask them if they prefer to switch to English. If they confirm or prefer it, you are authorized to change your language and continue the conversation in English. IMPORTANT: Whenever the conversation language switches (e.g. from Spanish to English), you MUST output the exact tag '[SWITCH_LANG: EN]' in your text transcription. If you switch from English to Spanish, you MUST output '[SWITCH_LANG: ES]'. Do not say these tags out loud, just output them in your text transcription at the start of your turn."
