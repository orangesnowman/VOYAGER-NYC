  ...
  wss.on("connection", async (clientWs, request) => {
    ...
    async function connectSession(modelName: string): Promise<any> {
      ...
      const languageInstruction = lang === "ES" 
        ? "\n\nLANGUAGE CONFIGURATION: The user's preferred language is Spanish (ES). You should speak primarily in Spanish, and translate conversational concepts, key phrases, lessons, and corrections to English. Guide the user in Spanish, but teach and translate key elements to English to help them learn. IMPORTANT: Whenever the conversation language switches (e.g. from Spanish to English), you MUST output the exact tag '[SWITCH_LANG: EN]' in your text transcription. If you switch from English to Spanish, you MUST output '[SWITCH_LANG: ES]'. Do not say these tags out loud, just output them in your text transcription at the start of your turn."
