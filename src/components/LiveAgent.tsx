    ...
    try {
      ...
      ws.onopen = () => {
        ...
        if (isBilingualModeRef.current) {
          greeting += "\n\n[SYSTEM MESSAGE: You are now in BILINGUAL TRANSLATION MODE. For EVERY SINGLE response, you must first speak and write your response in Spanish, and then immediately repeat the exact same response only in English. Separate the Spanish and English sentences with a slash '/'. Your entire response must consist of the Spanish version followed directly by the English translation, both in your voice output and in your text transcription. Actively encourage the user to repeat the English translations to practice their pronunciation! Add quick encouraging invitations like '¡Pruébalo en voz alta!' or '¿Te animas a repetirlo?']";
