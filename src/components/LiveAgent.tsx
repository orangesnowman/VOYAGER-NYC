    ...
    if (wasTranslateMode !== isTranslateMode) {
      if (wsRef.current && wsRef.current.readyState === WebSocket.OPEN) {
        const msgText = isTranslateMode 
          ? "[SYSTEM MESSAGE: Mode changed. You are now in INSTANT TRANSLATION MODE. You must immediately speak and write a brief explanation in Spanish (only one warm sentence) explaining what this mode does (that you will act as a real-time speech translator, translating Spanish to English and English to Spanish instantly). Do NOT say 'Understood' or 'Entendido'.]"
